...
const Sidebar = () => {
  ...
  // Cập nhật danh sách menu thêm phần Lớp học
  const menuItems = [
    { path: '/', label: 'Tổng quan', icon: LayoutDashboard },
    { path: '/semester', label: 'Quản lý học kỳ', icon: CalendarRange },
    // { path: '/reregiter-course', label: 'Mở lớp học lại', icon: Repeat },
    ...
    // { path: '/attendance', label: 'Kiểm soát điểm danh', icon: ClipboardCheck },
